...
<body>
  ...
  $view = $_GET['view']; 
  $sql = "SELECT * FROM contact WHERE id = '$view' ";
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="content-row">
              <h2 class="content-row-title">Details</h2>
              <div class="row">
                <div class="container">
                  <div class="col-xs-12.col-sm-9">
                    ...
                    <p><strong style="display: inline-block; width: 105px;">Date: </strong>&nbsp;
                      <?php echo $row['date']; ?> </p>
                    <p><strong style="display: inline-block; width: 105px;">Description: </strong>&nbsp;
                      <?php echo $row['detail']; ?> </p>
                    <br><br>
                    <a href="contact-table.php" class="btn btn-info">Back</a>
                  </div>
                </div>
