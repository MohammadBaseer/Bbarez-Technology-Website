        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="content-row">
              <h2 class="content-row-title">RFQ Details</h2>
              <div class="row">
...
{
?>
                        <td><a href="..\documents\<?php echo $row['attachment']; ?>"
                            target="..\documents\<?php echo $row['attachment'];?>">Download File</a></td>
                        <?php
}
...
?>
                        ...
                        <td nowrap="" style="width: 180px;text-align: justify;">
                        ...
                        <td>
                          <a href="rfq-details.php?view=<?php echo $row['id'];?>" data-toggle="tooltip" title="View">
                            <i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
                          </a>&nbsp;&nbsp;
                          <a href="include/delete.php?del_rfq=<?php echo $row['id'];?>"
